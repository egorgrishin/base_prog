...
print(not not (name == "John" or age == 17))  # Напишите логическое выражение со значением "человека зовут John или ему 17" с использованием оператора not
...
print(name != 'John' and age > 20 and name[0] != 'Е')