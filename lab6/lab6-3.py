...
my_module.hello_world('PEP 8')  # Вызовите функцию hello_world из модуля my_module
...
print(hello_world('PEP 8'))  # Функция hello_world должна вызываться без указания модуля
